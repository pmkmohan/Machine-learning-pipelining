...
#classifier = SVC()
#classifier = SVC(C=10,kernel='sigmoid',degree =4,gamma='auto')
#classifier = SVC(C=1,kernel='poly',degree =3,gamma='scale')
classifier = SVC(C=1,kernel='rbf',degree =3,gamma='scale')
